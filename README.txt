...
a persistence unit "Banco_ServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Banco_Servidor\pom.xml":
...
artifact ("Banco_Servidor.war") is already built. You can build
